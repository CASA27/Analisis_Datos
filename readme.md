...
2. **Dashboard Interactivo**: archivo .pbix que tendra un dashboard interactivo, para permitir explorar y visualizar los datos de manera dinámica, indicadores, graficas y KPIs (Indicadores Clave de Desempeño) que nuestro cliente ha solicitado, OACI. [da.pbix](https://github.com/CASA27/Analisis_Datos/blob/master/da.pbix)
...
+ ETL/: Contiene los scripts y archivos relacionados con el proceso de Extracción, Transformación y Carga de los datos. [etl.ipynb](https://github.com/CASA27/Analisis_Datos/blob/master/etl.ipynb)
